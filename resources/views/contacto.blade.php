...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <div class="card-body">
       <form class="p-2 mb-2 rounded shadow bg-secondary text-white" id="FormContacto" method="POST" action="{{ route('enviodemensaje.store')}}">
            @csrf
      ...
      <button type="submit" class="btn btn-light" onclick="document.getElementById('FormContacto').submit();">Enviar</button>
    </form>
                </div>
            </div>
        </div>
